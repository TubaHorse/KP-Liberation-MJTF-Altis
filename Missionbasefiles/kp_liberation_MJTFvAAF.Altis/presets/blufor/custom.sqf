...
light_vehicles = [
    ["EF_B_Quadbike_01_MJTF_Des",50,0,25],                              // Quad Bike
...
elite_vehicles = [
    ...
    "EF_B_MBT_01_TUSK_MJTF_Des",                                                  // M2A4 Slammer UP
    "B_MBT_01_arty_F",                                                  // M4 Scorcher
    "EF_B_MBT_01_mlrs_MJTF_Des",                                                  // M5 Sandstorm MLRS
    "EF_B_Heli_Attack_01_dynamicLoadout_MJTF_Des",                                // AH-99 Blackfoot
    "EF_B_AH99J_MJTF_Des",                                               // AH-99J
    "EF_B_UAV_02_dynamicLoadout_MJTF_Des",                                        // MQ-4A Greyhawk
